...
exports.isActivee = async (req, res, next) => (res.locals.settings && res.locals.settings.siteStatus == 'active') ? next() : res.json({ success: false, message: 'Hệ thống đang tạm bảo trì!' })